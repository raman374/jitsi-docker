...
JIBRI_RECORDING_DIR='JIBRI_RECORDING_DIR=/config/recordings'
JIBRI_FINALIZE_RECORDING_SCRIPT_PATH='JIBRI_FINALIZE_RECORDING_SCRIPT_PATH=/config/recording.sh'
JIBRI_STRIP_DOMAIN_JID='JIBRI_STRIP_DOMAIN_JID=conference'
JIBRI_LOGS_DIR='JIBRI_LOGS_DIR=/config/logs'
DISPLAY='DISPLAY=:0'
